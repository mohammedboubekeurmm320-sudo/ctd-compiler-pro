...
const M3_SECTIONS: CTDSection[] = [
  {
    code: '3.2.S.1', title: 'General Information', required: true,
    fields: [
  ...
  {
    code: '3.2.S.2', title: 'Manufacture', required: true,
    fields: [
  ...
  {
    code: '3.2.S.3', title: 'Characterisation', required: true,
    fields: [
  ...
  {
    code: '3.2.S.4', title: 'Control of Drug Substance', required: true,
    fields: [
  ...
  {
    code: '3.2.S.5', title: 'Reference Standards or Materials', required: true,
    fields: [
  ...
  {
    code: '3.2.S.6', title: 'Container Closure System', required: true,
    fields: [
  ...
  {
    code: '3.2.S.7', title: 'Stability', required: true,
    fields: [
  ...
  {
    code: '3.2.P.1', title: 'Description and Composition of the Drug Product', required: true,
    fields: [
  ...
  {
    code: '3.2.P.2', title: 'Pharmaceutical Development', required: true,
    fields: [
  ...
  {
    code: '3.2.P.3', title: 'Manufacture', required: true,
    fields: [
  ...
  {
    code: '3.2.P.4', title: 'Control of Excipients', required: false,
    fields: [
  ...
  {
    code: '3.2.P.5', title: 'Control of Drug Product', required: true,
    fields: [
  ...
  {
    code: '3.2.P.7', title: 'Container Closure System', required: true,
    fields: [
  ...
  {
    code: '3.2.P.8', title: 'Stability', required: true,
    fields: [
...
const M4_SECTIONS: CTDSection[] = [
  {
    code: '4.2.1', title: 'Pharmacology', required: true,
    fields: [
  ...
  {
    code: '4.2.2', title: 'Pharmacokinetics', required: true,
    fields: [
  ...
  {
    code: '4.2.3', title: 'Toxicology', required: true,
    fields: [
...
const M5_SECTIONS: CTDSection[] = [
  {
    code: '5.3.1', title: 'Reports of Biopharmaceutic Studies', required: true,
    fields: [
  ...
  {
    code: '5.3.3', title: 'Reports of Human PK Studies', required: true,
    fields: [
  ...
  {
    code: '5.3.5', title: 'Reports of Efficacy and Safety Studies', required: true,
    fields: [
      ...
      textareaField('safety_results', 'Résultats de sécurité'),
    ],
  },
  {
    code: '5.3.6', title: 'Reports of Post-Marketing Experience', required: false,
    fields: [
...
const M2_SECTIONS: CTDSection[] = [
  {
    code: '2.3', title: 'Quality Overall Summary', required: true,
    fields: [
  ...
  {
    code: '2.4', title: 'Nonclinical Overview', required: true,
    fields: [
      textareaField('nonclinical_overview', 'Vue d\'ensemble préclinique'),
    ],
  },
  {
    code: '2.5', title: 'Clinical Overview', required: true,
    fields: [
...
export function getCTDProfile(ctdType: CTDType, authority: RegulatoryAuthority): CTDProfile {
